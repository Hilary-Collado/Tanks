...
namespace Tanks.Complete
{
    ...
    public class TankMovement : MonoBehaviour
    {
        ...
        //	{
        //		Debug.LogError("❌ TankInputUser o su ActionAsset no están inicializados.");
        //		return;
        //	}

        //	if (m_MoveAction == null || m_TurnAction == null)
        //	{
        //		Debug.LogError("❌ Las acciones Vertical u Horizontal no fueron encontradas en el InputActionAsset.");
        //		return;
        //	}
